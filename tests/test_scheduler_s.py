...
def setup_scheduler(mock_worker_manager):
    scheduler = Scheduler_s(time_frames={"21.07": [{"start": "8:00", "end": "8:15", "allocation": 1}, {"start": "9:00", "end": "9:15", "allocation": 2}]}, variant="S", start="7:00", end="14:00")
...
def test_make_schedule_with_one_worker(setup_scheduler):
    ...
    expected_schedule = {"21.07": [{"8:00-8:15": [mock_worker_1]}, {"9:00-9:15": [mock_worker_1, mock_worker_2]}]}  # Expected to use the worker's name
